                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        return SearchResultHourly(
                          ...
                          imgUrl:
                              forecast.hourly!.hourly[index].weather![0].icon!,
                        );
                      },
                  ...
                  Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) => SearchResultDaily(
                        ...
                        imgUrl: forecast.daily!.daily[index].weather![0].icon!,
                        weather: forecast
                    ...
                    children: [
                      ...
                      forecast.current!.current.uvi! > 0.0
                          ? SearchResultDetail(
                              ...
                              title: 'Sunset',
                              value: getTime(forecast.current!.current.sunset),
                            )
                          : SearchResultDetail(
                              imgUrl: 'assets/icons/ic_sunrise.png',
                              title: 'Sunrise',
                              value: getTime(forecast.current!.current.sunrise),
                            ),
                      SearchResultDetail(
